...
void Shader::setMatrix4(const GLchar* name, const Matrix4& matrix, const bool transpose)
{
    if(transpose) glUniformMatrix4fv(glGetUniformLocation(id, name), 1, GL_TRUE, matrix.getAsFloatPtr());
